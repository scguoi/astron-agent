...
在您的贡献被接受之前，您必须签署贡献者许可协议（CLA）。这是为了厘清您贡献内容所授予的知识产权许可。

- **个人贡献者**：请签署[个人贡献者许可协议（ICLA）](docs/ICLA.md)
- **公司贡献者**：如果您是以公司名义贡献，请签署[公司贡献者许可协议（CCLA）](docs/CCLA.md)

### 如何签署

1. 下载并打印相应的 CLA 文档
2. 填写并签署协议
3. 扫描签署后的 PDF 并发送至：**ifly_opensource@iflytek.com**

在我们收到您签署的 CLA 之前，您的首个拉取请求将不会被合并。
